const http_problem = require('./schemas/HTTP_Problem')
    ...
    "headers": {
      ...
      "Location": {
        ...
        "schema": {
          ...
          "example": "https://example.com/api/v1/Trabajo/1936"
        }
      }
    },
    "responses": {
      ...
      "Response_422": {
        "description": "`UNPROCESSABLE ENTITY` Falta alguno de los atributos obligatorios (`nombre`, `empresa`, `version` o `año_publicación`)\n",
        "content": {
          "application/problem+json": {
            "schema": {
              "$ref": "#/components/schemas/HTTP_Problem"
